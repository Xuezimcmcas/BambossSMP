...
public abstract class TypedModCommand<T> extends CommandWrapper {

    public TypedModCommand(@NotNull BambossSMP plugin, @NotNull String name, @NotNull ConfigurationSection section) {
    ...
    public abstract T get(@NotNull String argument);
