...
public class TPAcceptCommand extends TypedCommand<Player> {

    public TPAcceptCommand(@NotNull BambossSMP plugin, @NotNull ConfigurationSection section) {
        super(plugin, "tpaccept", section);
    }
